...
export class PedidoGatewayInterfaceFilter {
  ...
  public orderField: PedidoGatewayInterfaceFilterOrderField =
    PedidoGatewayInterfaceFilterOrderField.DATA_CADASTRO;
  public orderDirection: PedidoGatewayInterfaceFilterOrderDirection =
