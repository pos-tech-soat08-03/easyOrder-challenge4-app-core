...
} from "../../Core/Entity/ValueObject/StatusTransacaoValueObject";
...
export class TransactionGateway implements TransactionGatewayInterface {
  ...
  public async salvarTransaction(
  ...
  public async atualizarTransactionsPorId(
    id: string,
    transaction: TransactionEntity
  ...
  public async buscarTransactionPorId(
    id: string
  ): Promise<TransactionEntity | undefined> {
    ...
    return new TransactionEntity(
      ...
      new StatusTransacaoValueObject(
        transaction.statusTransacao as StatusTransacaoEnum
      ),
  ...
  public async listarTransactionsPorPedido(
    idPedido: string
