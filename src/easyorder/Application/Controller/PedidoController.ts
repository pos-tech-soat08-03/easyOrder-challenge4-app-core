...
export class PedidoController {
  ...
  public static async BuscaPedidoPorId(
    ...
    try {
      ...
      const response = await PedidoUsecases.BuscaPedidoPorId(
        pedidoGateway,
        pedidoId
      );
  ...
  public static async CancelarPedido(
    ...
    try {
      ...
      const response = await PedidoUsecases.CancelarPedido(
        pedidoGateway,
        pedidoId
      );
  ...
  public static async CheckoutPedido(
    ...
    try {
      ...
      const response = await PedidoUsecases.CheckoutPedido(
        pedidoGateway,
        transactionGateway,
        servicoPagamento,
        pedidoId
  ...
  public static async AdicionarComboAoPedido(
    ...
    try {
      const pedidoGateway = dbConnection.gateways.pedidoGateway;
      const produtoGateway = productService.gateways.produtoGateway;
  ...
  public static async RemoverComboDoPedido(
    ...
    try {
      ...
      const response = await PedidoUsecases.RemoverComboDoPedido(
        pedidoGateway,
        pedidoId,
        comboId
      );
